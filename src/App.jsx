...
function App() {
  ...
  <h1 class="heading"> Likoebe Maruping  </h1>
    ...
    <div align="center"> 
    <iframe src="https://open.spotify.com/embed/episode/4zZVi6XcNTHlLFdhcNz7mF" width="90%" height="232" frameBorder="0" allowtransparency="true" allow="encrypted-media"></iframe>
  </div>
  </div>
  ...
  <h1 class="heading"> Seth Radman  </h1>
    <h3 class="description"> Seth Radman is a Startup Founder & Tech Entrepreneur from ATL. He has built products people love to use. Co-Founder / CTO @ Infinite Giving, the robo-advisor investment platform for nonprofits. 
    Co-Founder / CEO @ Upbeat Music App, helping musicians play together virtually in real-time online.
    Prev Founder / CEO @ Crescendo, an AI music trainer known as “Guitar Hero for real instruments”. Grew to 1 million users. Acquired by Ultimate Guitar in 2019.
    He has designed, built, and launched over 40 mobile and web apps. Featured on the App Store 100+ times across the world and selected as Apple's App of the Day.
</h3>

    <div align="center"> 
    <iframe src="https://open.spotify.com/embed/episode/1Zs68ku4C8o0ZwgblPsRWi?theme=0" width="90%" height="232" frameBorder="0" allowtransparency="true" allow="encrypted-media"></iframe>
  </div>
  </div>

  <div class="podcast-episode2">
  <h1 class="heading"> Charu Thomas  </h1>
    <h3 class="description"> Charu is currently building Ox with her world-class teammates to help retailers and 3PLs get customer orders out the door faster through nano and microfulfillment automation. Prior to that, she was an internationally award-winning researcher from Georgia Tech's #1 ISYE program.
</h3>

    <div align="center"> 
    <iframe src="https://open.spotify.com/embed/episode/2hVMvvyfKT83ZYdfaFfCTh?theme=0" width="90%" height="232" frameBorder="0" allowtransparency="true" allow="encrypted-media"></iframe>
  </div>
  </div>

  <div class="podcast-episode2">
  <h1 class="heading"> Christopher Cherian  </h1>
    <h3 class="description"> Christopher is passionate about building things and connecting with people. He is currently working with his team on building Gatherly, a software product that seamlessly connects people to produce engaging virtual events. Gatherly has raised money, signed hundreds of corporate customers, and is continuing to grow.
</h3>

    <div align="center"> 
    <iframe src="https://open.spotify.com/embed/episode/0flQzyXmFmKXaAR0SBD5vX?theme=0" width="90%" height="232" frameBorder="0" allowtransparency="true" allow="encrypted-media"></iframe>
  </div>
  </div>

  <div class="podcast-episode2">
  <h1 class="heading"> Jay Shaffer  </h1>
    <h3 class="description"> Prepare Intro // TO DO
</h3>

    <div align="center"> 
    <iframe src="https://open.spotify.com/embed/episode/5ptePPJfq2TPML0FkTVm98?theme=0" width="90%" height="232" frameBorder="0" allowtransparency="true" allow="encrypted-media"></iframe>
  </div>
  ...
  <h1 class="heading"> Deep Kakkad  </h1>
    ...
    <div align="center"> 
    <iframe src="https://open.spotify.com/embed/episode/2VtkKgVD7Lk83GK5OyU2IK?theme=0" width="90%" height="232" frameBorder="0" allowtransparency="true" allow="encrypted-media"></iframe>
  </div>
  </div>
  ...
  <h1 class="heading"> Michael Gracie  </h1>
    ...
    <div align="center"> 
    <iframe src="https://open.spotify.com/embed/episode/1JsQsAxgfy7qr9DPN4GSrP?theme=0" width="90%" height="232" frameBorder="0" allowtransparency="true" allow="encrypted-media"></iframe>
  </div>
  </div>
  ...
  <h1 class="heading"> Richard Lee  </h1>
    ...
    <div align="center"> 
    <iframe src="https://open.spotify.com/embed/episode/5YximCIAA1yYUntV0Ms3Qm?theme=0" width="90%" height="232" frameBorder="0" allowtransparency="true" allow="encrypted-media"></iframe>
  </div>
  </div>
  ...
  <h1 class="heading"> Ash Bhimasani  </h1>
    ...
    <div align="center"> 
    <iframe src="https://open.spotify.com/embed/episode/7eoCdo2qOHyUUlMdOBit4d?theme=0" width="90%" height="232" frameBorder="0" allowtransparency="true" allow="encrypted-media"></iframe>
